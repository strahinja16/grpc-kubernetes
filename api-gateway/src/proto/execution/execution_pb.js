 ...
 * @const
 */
proto.execution.OrderDto.repeatedFields_ = [3];
...
/**
 * repeated OrderSpecificationDto orderSpecs = 3;
...
proto.execution.OrderDto.prototype.getOrderspecsList = function() {
  return /** @type{!Array<!proto.execution.OrderSpecificationDto>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.execution.OrderSpecificationDto, 3));
};
...
proto.execution.OrderDto.prototype.addOrderspecs = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.execution.OrderSpecificationDto, opt_index);
};
